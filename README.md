...
```html
<ui-carousel role="region" aria-roledescription="carousel" aria-label="Launch feature tour">
  <item-group>
    <ui-item role="group" aria-roledescription="slide" aria-label="1 of 2">
      Track signups and activation in the same view.
    </ui-item>
    <ui-item role="group" aria-roledescription="slide" aria-label="2 of 2">
      Compare campaign cohorts without losing the narrative.
    </ui-item>
  </item-group>
