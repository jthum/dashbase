...
function renderManualComponentFile(contract: ComponentContract) {
  ...
  return [
    ...
    `/* Generated by scripts/generate-react.ts for ${contract.name}. */`,
...
function renderPackageReadme(
  ...
  const lines = [
    ...
    "",
    "This folder is generated by `scripts/generate-react.ts`.",
    "",
    "Recommended usage:",
    "",
...
function renderPatternManualFile(
  ...
  return [
    `/* Generated by scripts/generate-react.ts for ${entry.contract.title}. */`,
    'import React from "react";',
