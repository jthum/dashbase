...
import { Carousel, CarouselGroup, CarouselItem, CarouselControls, CarouselPrevButton, CarouselNextButton, CarouselDots, CarouselDot } from "@dashbase/vue/carousel";
</script>
```
...
```ts
import { Carousel, CarouselGroup, CarouselItem, CarouselControls, CarouselPrevButton, CarouselNextButton, CarouselDots, CarouselDot, carouselAssets } from "@dashbase/vue/carousel/manual";
```
