...
<script lang="ts">
  import { Combobox, ComboboxInput, ComboboxPanel, ComboboxOption, ComboboxEmpty } from "./index.ts";
</script>

<section aria-labelledby="assigneeCombobox-title">
...
<section aria-labelledby="frameworkCombobox-title">
