...
```svelte
<script lang="ts">
  import { FormsFormFieldSelectWithHelperError } from "@dashbase/svelte/patterns/forms/form-field/select-with-helper-error";
</script>
```

```ts
import { FormsFormFieldSelectWithHelperError, formsFormFieldSelectWithHelperErrorAssets } from "@dashbase/svelte/patterns/forms/form-field/select-with-helper-error/manual";
```
